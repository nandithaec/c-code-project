...
//	twos_comp = (~(r1-> W) + 1); //Take negation of W and add 1 for 2's comp addition. Keep only 8 bits
	...
	PRINT("~W (hex): %x\n", twos_comp);
		...
		PRINT("Zero flag reset within SUBWF:\n");
		}
	...
	PRINT("temp_num (hex)=%x, ~W (hex): %x\n", temp_num, twos_comp);
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within SUBWF, (destination = register file)\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	if (i1-> d==0) //	d=0 means- destination is W register i.e., accumulator 
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within DECF:\n");
		}
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within DECF, (destination = register file)\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	if (i1-> d==0) //	d=0 means- destination is W register i.e., accumulator 
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within IORWF:\n");
		}
		...
		if( r1-> GP_Reg[i1-> reg_index] ==0)
			...
			{
			r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
			PRINT("Zero flag reset within IORWF, (destination = register file)\n");
			}
...
//	W is the accumulator and d is the destination bit
	...
	if (i1-> d==0) //	d=0 means- destination is W register i.e., accumulator 
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within ANDWF:\n");
		}
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within 	ANDWF, (destination = register file)\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	if (i1-> d==0) //	d=0 means- destination is W register i.e., accumulator 
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within XORWF:\n");
		}
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within XORWF, (destination = register file)\n");
		}
		}
...
//		for (i=0;i<=7;i++)
	...
	if (i1-> d==0) //	d=0 means- destination is W register i.e., accumulator 
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within ADDWF\n");
		}
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within ADDWF, (destination = register file)\n");
		}
...
//		for (i=0;i<=7;i++)
	...
	case 15: //COMF
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within COMF:\n");
		}
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within COMF, (destination = register file)\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	if (i1-> d==0) //	d=0 means- destination is W register i.e., accumulator 
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within INCF:\n");
		}
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within INCF, (destination = register file)\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	PRINT("After execution:\n");
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within IORLW:\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	PRINT("After execution:\n");
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within ANDLW:\n");
		}
...
//	W is the accumulator and d is the destination bit
	...
	PRINT("After execution:\n");
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within XORLW:\n");
		}
...
//	W is the accumulator 
	...
	PRINT("~W (hex): %x\n", twos_comp);
		...
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within SUBLW:\n");
		}
...
//		for (i=0;i<=7;i++)
	...
	if( r1-> W == 0)
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] | 0x04; //Z flag set in the status register
		PRINT("Zero flag set within ADDLW:\n");
		}
	else
		{
		r1-> GP_Reg[3] = r1-> GP_Reg[3] & 0xFB; //Z flag reset in the status register
		PRINT("Zero flag reset within ADDLW:\n");
		}
