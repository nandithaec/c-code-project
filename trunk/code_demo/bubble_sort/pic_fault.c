...
//				if (loop == pic_registers.max_instr) //If end of program is reached
	...
	printf("GP_Reg[13]=%x\n", pic_registers.GP_Reg[0x13]);
	printf("GP_Reg[15]=%x\n", pic_registers.GP_Reg[0x15]);
	printf("GP_Reg[17]=%x\n", pic_registers.GP_Reg[0x17]);
	printf("GP_Reg[19]=%x\n", pic_registers.GP_Reg[0x19]);
	printf("GP_Reg[1B]=%x\n", pic_registers.GP_Reg[0x1B]);
